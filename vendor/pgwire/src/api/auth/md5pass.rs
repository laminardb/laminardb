...
#[derive(Debug)]
struct Md5AuthenticationState(Vec<u8>);
        ...
        PgWireError: From<<C as Sink<PgWireBackendMessage>>::Error>,
    {
        match message {
            PgWireFrontendMessage::Startup(ref startup) => {
                ...
                client
                    .session_extensions()
                    .insert(Md5AuthenticationState(salt_and_pass.password));
            ...
            PgWireFrontendMessage::PasswordMessageFamily(pwd) => {
                ...
                let cached_pass = client
                    .session_extensions()
                    .get::<Md5AuthenticationState>()
                    .ok_or(PgWireError::MalformedMessage(
                        "MD5 password response arrived before its challenge",
                    ))?;

                if pwd.password.as_bytes() == cached_pass.0.as_slice() {
