...
| **Phase** | 6c |
| **Effort** | XL (8-13 days) |
| **Dependencies** | F-SERVER-005 (Constellation Mode), F-EPOCH-003 (Reassignment Protocol) |
| **Blocks** | None |
| **Owner** | TBD |
| **Created** | 2026-02-16 |
...
/// in the constellation can track each other's status.
...
pub struct PartitionTransfer {
    ...
    pub target_node: ConstellationNodeId,
...
- [F-SERVER-005: Constellation Mode](F-SERVER-005-constellation-mode.md) -- Constellation startup
