...
- Partition count changes after constellation formation
...
pub struct KafkaDiscoveryConfig {
    ...
    /// All LaminarDB nodes in the same constellation must use the same group.
    pub group_id: String,
...
impl Default for KafkaDiscoveryConfig {
    fn default() -> Self {
        Self {
            ...
            group_id: "laminar-constellation".to_string(),
            topics: Vec::new(),
...
- [ ] How should we handle Kafka topic partition count changes after constellation formation?
