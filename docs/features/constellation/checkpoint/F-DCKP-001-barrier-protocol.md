...
///
/// **NEW in Constellation**: The existing codebase does NOT have a
...
partition-aware executor introduced in the Constellation Architecture:
...
- **Constellation mode**: `StreamMessage<T>` + cross-node barrier forwarding (F-DCKP-008)
