...
See standalone file: [F-PERF-004-delta-checkpoint-benchmark.md](F-PERF-004-delta-checkpoint-benchmark.md)
...
|----------|-----------|--------|-------------|
| 50% | 1GB | < 5s | `delta_checkpoint/50pct/1GB` |
| 80% | 1GB | < 10s | `delta_checkpoint/80pct/1GB` |
| 95% | 1GB | < 30s | `delta_checkpoint/95pct/1GB` |
...
- [F-PERF-004: Delta Checkpoint](F-PERF-004-delta-checkpoint-benchmark.md) -- Related benchmark
