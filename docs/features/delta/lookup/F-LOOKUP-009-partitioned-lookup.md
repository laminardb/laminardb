...
- Hash-partition lookup table keys across delta nodes
...
impl PartitionMap {
    ...
    ///
    /// Called when a node joins or leaves the delta.
...
///
/// Distributes lookup data across delta nodes by primary key hash.
...
- [ARCHITECTURE.md](../../../ARCHITECTURE.md) -- Ring model and delta design
