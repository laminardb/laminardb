//! Partition migration protocol for the constellation.
//!
...
///
/// Placeholder — fully implemented in F-EPOCH-003.
#[derive(Debug)]
...
mod tests {
    ...
    fn test_executor_cleanup_terminal() {
        ...
        exec.active_migrations.push(MigrationTask::new(
            1,
            NodeId(1),
            NodeId(2),
            1,
