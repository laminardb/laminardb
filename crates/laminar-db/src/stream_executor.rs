//! `DataFusion` micro-batch stream executor (legacy, test-only).
//!
//! Replaced by `OperatorGraph` for production execution. Utility functions
//! previously shared from this module have been extracted to
//! [`crate::sql_analysis`]. This module is retained solely for its
...
use laminar_sql::translator::{
    AsofJoinTranslatorConfig, OrderOperatorConfig, StreamJoinConfig, TemporalJoinTranslatorConfig,
...
use crate::sql_analysis::{
    apply_topk_filter, compute_closed_boundary, detect_asof_query, detect_stream_join_query,
    detect_temporal_query, extract_projection_exprs, extract_projection_filter,
    extract_table_references, infer_ts_format_from_batch, single_source_table,
    CompiledPostProjection,
};
...
mod tests {
    use super::*;
    use crate::sql_analysis::{detect_temporal_probe_query, emit_clause_to_core, sql_emit_to_core};
